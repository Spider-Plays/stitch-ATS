...
import { adminMetrics, candidatePipelineCounts, recruiterMetrics } from '../../lib/dashboardPage'
import { recruitmentSourceBreakdown } from '../../lib/featureCandidates'
import { dashboardsForPages } from '../../lib/misPage'
import { requirementStats } from '../../lib/requirementPage'
...
const MisDashboard = () => {
  ...
  const { data: users = [] } = useQuery({
    ...
    enabled: role === 'ADMIN' || role === 'HR_HEAD' || role === 'HR_MANAGER',
  })
